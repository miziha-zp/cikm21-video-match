...
#         self.transformer_frame = TransformerFrame(transformer_frame_config)
        ...
        self.fusion_net = SE_MLP(in_channel, 8, hiddensz, outsz)
        self.tagfusion_net = SE_MLP(pretrain_fusion_channel, 8, hiddensz, outsz)
        self.ichfusion_net = SE_MLP(ich_fusion_channel, 8, hiddensz, outsz)
